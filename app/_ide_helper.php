...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         * CreateCase and return an un-saved model instance.
         *
        ...
        /**
         * CreateCase a collection of models from plain arrays.
         *
         * @param array $items
        ...
        /**
         * CreateCase a collection of models from a raw query.
         *
         * @param string $query
        ...
        /**
         * CreateCase or update a record matching the attributes, and fill it with values.
         *
         * @param array $attributes
         * @param array $values
         * @return TModel
        ...
        /**
         * CreateCase a record matching the attributes, or increment the existing record.
         *
         * @param array $attributes
         * @param string $column
        ...
        /**
         * CreateCase a new instance of the model being queried.
         *
         * @param array $attributes
         * @return TModel
         * @static
        ...
        /**
         * CreateCase a new query instance for nested where condition.
         *
         * @return \Illuminate\Database\Query\Builder
         * @static
         */
        ...
        /**
         * CreateCase a raw database expression.
         *
         * @param mixed $value
